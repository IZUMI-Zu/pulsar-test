...
public final class CommandEndTxnOnSubscriptionResponse {
	...
	public CommandEndTxnOnSubscriptionResponse setRequestId(long requestId) {
		this.requestId = requestId;
		_bitField0 |= _REQUEST_ID_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandEndTxnOnSubscriptionResponse clearRequestId() {
		_bitField0 &= ~_REQUEST_ID_MASK;
		return this;
	}
	...
	public CommandEndTxnOnSubscriptionResponse setTxnidLeastBits(long txnidLeastBits) {
		this.txnidLeastBits = txnidLeastBits;
		_bitField0 |= _TXNID_LEAST_BITS_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandEndTxnOnSubscriptionResponse clearTxnidLeastBits() {
		_bitField0 &= ~_TXNID_LEAST_BITS_MASK;
		txnidLeastBits = 0;
		return this;
	}
	...
	public CommandEndTxnOnSubscriptionResponse setTxnidMostBits(long txnidMostBits) {
		this.txnidMostBits = txnidMostBits;
		_bitField0 |= _TXNID_MOST_BITS_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandEndTxnOnSubscriptionResponse clearTxnidMostBits() {
		_bitField0 &= ~_TXNID_MOST_BITS_MASK;
		txnidMostBits = 0;
		return this;
	}
	...
	public CommandEndTxnOnSubscriptionResponse setError(ServerError error) {
		this.error = error;
		_bitField0 |= _ERROR_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandEndTxnOnSubscriptionResponse clearError() {
		_bitField0 &= ~_ERROR_MASK;
		return this;
	}
	...
	public CommandEndTxnOnSubscriptionResponse setMessage(String message) {
	...
	public CommandEndTxnOnSubscriptionResponse clearMessage() {
		_bitField0 &= ~_MESSAGE_MASK;
		message = null;
		_messageBufferIdx = -1;
		_messageBufferLen = -1;
	...
	public CommandEndTxnOnSubscriptionResponse clear() {
		txnidLeastBits = 0;
		txnidMostBits = 0;
		message = null;
		_messageBufferIdx = -1;
	...
	public CommandEndTxnOnSubscriptionResponse copyFrom(CommandEndTxnOnSubscriptionResponse _other) {
		_cachedSize = -1;
