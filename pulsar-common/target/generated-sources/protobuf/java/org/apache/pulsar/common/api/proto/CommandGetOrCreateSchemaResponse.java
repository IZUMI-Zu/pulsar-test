...
public final class CommandGetOrCreateSchemaResponse {
	...
	public CommandGetOrCreateSchemaResponse setRequestId(long requestId) {
		this.requestId = requestId;
		_bitField0 |= _REQUEST_ID_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandGetOrCreateSchemaResponse clearRequestId() {
		_bitField0 &= ~_REQUEST_ID_MASK;
		return this;
	}
	...
	public CommandGetOrCreateSchemaResponse setErrorCode(ServerError errorCode) {
		this.errorCode = errorCode;
		_bitField0 |= _ERROR_CODE_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandGetOrCreateSchemaResponse clearErrorCode() {
		_bitField0 &= ~_ERROR_CODE_MASK;
		return this;
	}
	...
	public CommandGetOrCreateSchemaResponse setErrorMessage(String errorMessage) {
	...
	public CommandGetOrCreateSchemaResponse clearErrorMessage() {
		_bitField0 &= ~_ERROR_MESSAGE_MASK;
		errorMessage = null;
		_errorMessageBufferIdx = -1;
	...
	public CommandGetOrCreateSchemaResponse setSchemaVersion(byte[] schemaVersion) {
		setSchemaVersion(io.netty.buffer.Unpooled.wrappedBuffer(schemaVersion));
		return this;
	}
	public CommandGetOrCreateSchemaResponse setSchemaVersion(io.netty.buffer.ByteBuf schemaVersion) {
	...
	public CommandGetOrCreateSchemaResponse clearSchemaVersion() {
		_bitField0 &= ~_SCHEMA_VERSION_MASK;
		schemaVersion = null;
		_schemaVersionIdx = -1;
		_schemaVersionLen = -1;
	...
	public CommandGetOrCreateSchemaResponse clear() {
		errorMessage = null;
		_errorMessageBufferIdx = -1;
		_errorMessageBufferLen = -1;
		schemaVersion = null;
	...
	public CommandGetOrCreateSchemaResponse copyFrom(CommandGetOrCreateSchemaResponse _other) {
		_cachedSize = -1;
