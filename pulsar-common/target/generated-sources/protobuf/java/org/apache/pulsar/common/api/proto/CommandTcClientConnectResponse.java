...
public final class CommandTcClientConnectResponse {
	...
	public CommandTcClientConnectResponse setRequestId(long requestId) {
		this.requestId = requestId;
		_bitField0 |= _REQUEST_ID_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandTcClientConnectResponse clearRequestId() {
		_bitField0 &= ~_REQUEST_ID_MASK;
		return this;
	}

	private ServerError error;
	private static final int _ERROR_FIELD_NUMBER = 2;
	...
	private static final int _ERROR_MASK = 1 << (1 % 32);
	...
	public CommandTcClientConnectResponse setError(ServerError error) {
		this.error = error;
		_bitField0 |= _ERROR_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandTcClientConnectResponse clearError() {
		_bitField0 &= ~_ERROR_MASK;
		return this;
	}
	...
	private static final int _MESSAGE_FIELD_NUMBER = 3;
	...
	private static final int _MESSAGE_MASK = 1 << (2 % 32);
	...
	public CommandTcClientConnectResponse setMessage(String message) {
	...
	public CommandTcClientConnectResponse clearMessage() {
		_bitField0 &= ~_MESSAGE_MASK;
		message = null;
		_messageBufferIdx = -1;
		_messageBufferLen = -1;
	...
	public CommandTcClientConnectResponse clear() {
		message = null;
		_messageBufferIdx = -1;
		_messageBufferLen = -1;
		_parsedBuffer = null;
	...
	public CommandTcClientConnectResponse copyFrom(CommandTcClientConnectResponse _other) {
		_cachedSize = -1;
