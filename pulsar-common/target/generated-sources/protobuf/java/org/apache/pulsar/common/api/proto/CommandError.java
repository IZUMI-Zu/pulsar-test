...
public final class CommandError {
	...
	public CommandError setRequestId(long requestId) {
		this.requestId = requestId;
		_bitField0 |= _REQUEST_ID_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandError clearRequestId() {
		_bitField0 &= ~_REQUEST_ID_MASK;
		return this;
	}
	...
	public CommandError setError(ServerError error) {
		this.error = error;
		_bitField0 |= _ERROR_MASK;
		_cachedSize = -1;
		return this;
	}
	public CommandError clearError() {
		_bitField0 &= ~_ERROR_MASK;
		return this;
	}
	...
	public CommandError setMessage(String message) {
	...
	public CommandError clearMessage() {
		_bitField0 &= ~_MESSAGE_MASK;
		message = null;
		_messageBufferIdx = -1;
		_messageBufferLen = -1;
	...
	private static final int _REQUIRED_FIELDS_MASK0 = 0 | _REQUEST_ID_MASK | _ERROR_MASK | _MESSAGE_MASK;
	...
	public CommandError copyFrom(CommandError _other) {
		_cachedSize = -1;
